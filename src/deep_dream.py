...
def main():
    ...
    t_input = tensorflow.placeholder(numpy.float32, name='input') # define the input tensor
    imagenet_mean = 117.0
    ...
    def render_naive(t_obj, img0=img_noise, iter_n=20, step=1.0):
        t_score = tensorflow.reduce_mean(t_obj) # defining the optimization objective
        t_grad = tensorflow.gradients(t_score, t_input)[0] # behold the power of automatic differentiation!
        img = img0.copy()
